...
export const AIStatusBadge = () => {
  ...
  const checkConnection = async (forceCheck = false) => {
    ...
    try {
      console.log("Verificando conexión con OpenRouter API (Claude 3 Haiku)...");
      ...
      console.log("Respuesta de verificación de Claude:", data);
      ...
      console.error("Error al verificar conexión con Claude 3 Haiku:", error);
      setStatus("error");
